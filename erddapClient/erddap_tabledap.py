...
class ERDDAP_Tabledap(ERDDAP_Dataset):
    ...
    def __init__(self, url, datasetid, auth=None, lazyload=True, request_kwargs={}):
        ...
        """
        super().__init__(url, datasetid, 'tabledap', auth, lazyload=lazyload, request_kwargs=request_kwargs)
    ...
    def orderByDescending(self, variables):
        '''
        https://coastwatch.pfeg.noaa.gov/erddap/tabledap/documentation.html#orderByDescending
        '''
        self.addServerSideFunction('orderByDescending', variables)
        return self
    ...
    def orderBySum(self, variables):
        '''
        https://coastwatch.pfeg.noaa.gov/erddap/tabledap/documentation.html#orderBySum
        '''
        self.addServerSideFunction('orderBySum', variables)
        return self
